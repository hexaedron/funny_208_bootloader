...
In your main firmware, implement the logic to fetch and place the new firmware at `0x08020000`. All firmware verification should be performed by the main firmware, as the bootloader does not perform any checks. Set `BKP->DATAR1` to `0x1` in the main firmware. Afterward, reboot the chip, and the upgrade process will start automatically.
